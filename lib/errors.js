(function() {
  ...
  module.exports = function(globals) {
    var AppError, ExpectedError, FatalError, ForbiddenError, HandledInternalError, InternalError, InvalidArgumentsError, NotFoundError, ValidationError;
    ...
    AppError = (function(_super) {
      ...
      function AppError(message) {
        ...
        AppError.__super__.constructor.call(this, this.message);
        Error.call(this, this.message || this.name);
    ...
    InternalError = (function(_super) {
      ...
      function InternalError(message, ctx, originalError) {
        ...
        InternalError.__super__.constructor.call(this, this.message);
    ...
    InvalidArgumentsError = (function(_super) {
      ...
      function InvalidArgumentsError(message, ctx) {
        this.message = message;
        this.ctx = ctx;
        InvalidArgumentsError.__super__.constructor.call(this, this.message);
    ...
    ValidationError = (function(_super) {
      ...
      function ValidationError(message, ctx, errors) {
        ...
        this.ctx = ctx;
        this.errors = errors;
        ValidationError.__super__.constructor.call(this, this.message);
    ...
    ForbiddenError = (function(_super) {
      ...
      function ForbiddenError(message, ctx) {
        this.message = message;
        this.ctx = ctx;
        ForbiddenError.__super__.constructor.call(this, this.message);
    ...
    NotFoundError = (function(_super) {
      ...
      function NotFoundError(message, ctx) {
        this.message = message;
        this.ctx = ctx;
        NotFoundError.__super__.constructor.call(this, this.message);
    ...
    ExpectedError = (function(_super) {
      ...
      function ExpectedError(message, ctx) {
        this.message = message;
        this.ctx = ctx;
        ExpectedError.__super__.constructor.call(this, this.message);
    ...
    FatalError = (function(_super) {
      ...
      function FatalError(message, ctx, originalError) {
        ...
        this.ctx = ctx;
        this.originalError = originalError;
        FatalError.__super__.constructor.call(this, this.message);
    ...
    HandledInternalError = (function(_super) {
      ...
      function HandledInternalError(message, ctx, originalError) {
        ...
        this.ctx = ctx;
        this.originalError = originalError;
        HandledInternalError.__super__.constructor.call(this, this.message);
