(function() {
  ...
  module.exports = function(globals) {
    var ExpectedError, UserService, app, authenticate, logger;
    ...
    passport.deserializeUser(function(id, done) {
      ...
      return UserService.retrieveUserById(id).then(function(user) {
    ...
    passport.use(new LocalStrategy({
      ...
      foundUser = null;
      return UserService.retrieveUserByEmail(username, req.locals.ctx).then(function(user) {
        if (!user) {
          return null;
        }
        foundUser = user;
        return UserService.doesPasswordMatch(user, password, req.locals.ctx);
