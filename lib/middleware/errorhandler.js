(function() {
  ...
  module.exports = function(globals) {
    var ExpectedError, FatalError, ForbiddenError, HandledInternalError, InvalidArgumentsError, NotFoundError, ValidationError, app, handleBadRequest, handleError, handleExpectedError, handleFatalError, handleForbidden, handleHandledInternalError, handleInternalError, handleNotAuthorized, handleNotFound, handleValidationError, logger;
    ...
    handleError = function(err, req, res, next) {
      ...
      if (((err != null ? err.status : void 0) != null) && ((err != null ? err.status : void 0) === 403)) {
        ...
        return handleHandledError(err, req, res, next);
      } else {
    ...
    handleFatalError = function(err, req, res, next) {
      logger.emerg({
        message: "Handling fatal error on path=" + req.path,
        error: err.error || err
      });
      if (req.accepts(['html', 'json']) === 'json') {
        return res.json(500, {
